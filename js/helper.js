...
var HTMLdropdown = '<div class="dropdown fixed-right"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Resume Sections<span class="caret"></span></button><ul class="dropdown-menu dropdown-menu-right"><li><a href="#bio">Bio</a></li><li><a href="#work_experience">Work Experience</a></li><li><a href="#education">Education</a></li><li><a href="#online_courses">Online Classes</a></li><li><a href="#projects">Projects</a></li><li><a href="#volunteering">Volunteering</a></li><li role="separator" class="divider"></li><li><a href="mailto:neilstrain@gmail.com">Let\'s Connect</a></li></ul></div><div><hr/></div>';
