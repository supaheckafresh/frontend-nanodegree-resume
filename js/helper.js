...
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span><a href="%data%" target="_blank"><span class="white-text">%data%</span></a></li>';
...
var HTMLonlineDates = '<div class="date-text">%data%</div><br/><br/>';
